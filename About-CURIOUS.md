...
Try it: `python -m http.server 8000` → [http://localhost:8000/viz/index.html](http://localhost:8000/viz/index.html)
...
You don't need to install anything complicated. If you have Python on your computer:

```bash
# Download the code
git clone [this repo]
cd cocktail_cartography
...
That's it. The visualization runs entirely in your browser.
